...
它的具体来源就不多说了。之前看过很多文章都在分析这个跨窗口通信的技术，但是呢，我却没有看到有人把这个粒子效果给复现出来的。于是乎，我花了一整个周末，把这个粒子特效给肝了出来。尽管可能跟原特效相比有一点差距，但也表明了这种效果是可以被实现的。
...
粒子效果本身差不多就这样完成了。之后就是两球相互纠缠的动画，这个实现起来感觉是最有难度的，老实说我自己的那个版本的纠缠动画有一点生硬，并不像原效果里的那么丝滑、自然，也许是功夫还不到家吧，哈哈。
