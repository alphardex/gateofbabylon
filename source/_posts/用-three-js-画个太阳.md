...
![1.png](https://i.loli.net/2021/03/25/zoLU9iWrFeJD5dl.png)
...
`firePalette`函数是笔者之前逛[shadertoy](https://www.shadertoy.com)时看到的一种模拟火焰颜色的函数，觉得不错就直接拿来用了
...
![sun-base.gif](https://i.loli.net/2021/03/25/dfmtTqsIbzxYnao.gif)
...
[Sun](https://codepen.io/alphardex/pen/dyNYJag)
