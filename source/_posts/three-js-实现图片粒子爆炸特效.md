...
在我的[上一篇博文](https://juejin.cn/post/6937070693506875429)中，讲到了如何将 HTML 世界和 webgl 的世界同步起来，本文也是同样的思路，先同步好两个世界，再进行特效创作
...
<div class="relative w-screen h-screen">
  <div class="absolute w-screen h-screen flex-center opacity-0">
    <img
      src="https://i.loli.net/2021/03/08/uYcvELkr4dqFj9w.jpg"
...
噪声有很多种，最常见的有`perlin noise`、`simplex noise`等，本文用的是基于`simplex noise`的`curl noise`，在 google 上搜索`curl noise glsl`，很容易就能将下面的[噪声代码](https://github.com/cabbibo/glsl-curl-noise)搞到手（谷歌：关键时刻还是得靠劳资）
